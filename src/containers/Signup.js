...
export default function Signup() {
    ...
    function validateConfirmationForm(event) {
    ...
    function renderConfirmationForm() {
        return (
            <form onSubmit={handleConfirmationSubmit}>
                ...
                <LoaderButton block type="submit" bsSize="large" isLoading={isLoading} disabled={!validateConfirmationForm()}>Verify</LoaderButton>
            </form>
        );
    }
    ...
    function renderForm() {
        return (
            <form onSubmit={handleSubmit}>
                ...
                <LoaderButton block type="submit" bsSize="large" isLoading={isLoading} disabled={!validateForm()}>Signup</LoaderButton>
            </form>
        );
    }
